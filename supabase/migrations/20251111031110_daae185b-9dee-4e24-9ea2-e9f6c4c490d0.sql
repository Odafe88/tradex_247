...
-- Add balance constraints to prevent negative balances
ALTER TABLE public.profiles
ADD CONSTRAINT check_balance_crypto_non_negative CHECK (balance_crypto >= 0);

ALTER TABLE public.profiles
ADD CONSTRAINT check_balance_forex_non_negative CHECK (balance_forex >= 0);